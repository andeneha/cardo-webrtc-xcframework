Pod::Spec.new do |spec|
  ...
  spec.version = "125.6422.12-cardo-exp"
  ...
  spec.source = {
    :http => "https://github.com/andeneha/cardo-webrtc-xcframework/releases/download/125.6422.12-cardo-exp/WebRTC.xcframework.zip"
  }
